// Count_Kernel_Pairs_n_Primes_btw_Perfect_Squares.cpp
// Created by Alan Verdegraal October 27, 2022
//
// This gets the number of Ke rnel Pairs and Primes
// between Perfect Squares. It also prints out K12 and K22.
// Output: First_Square, Next_Square, n, n+1, #pairs, #primes.
//
#include <iostream>
#include <math.h>
#include <limits>
...
int main() {
	long long int beginning_value, ending_value, first_square, next_square;
	long long int total_pairs=0, total_primes=0;
    ...
    for (j = beginning_value; j <= ending_value; j++) {
		...
		cout << first_square << " " << next_square << " " << K21 << " " << K22 << " ";
		cout << total_pairs << " " << total_primes << endl;
	}
}
