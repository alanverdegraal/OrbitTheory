// Display_Sequences_and_Determine_If_Prime_long_long.cpp
...
// using increments from 1 to n. It calculates the "Orbit" On(m) for each 
// sequence, that is, the number of circuits around the circle with n points 
// before it reaches 1. It accumulates the sum of all these Orbits On(m) into 
...
int main() {
   ...
   for (m = 1; m <= n; m++) {  
      ...
      k = 1 + i;                      // starting value of the sequence
        ...
        cout << ";     ";
        cout << "On(m) = " << t << endl;   // print the Orbit for the particular sequence
