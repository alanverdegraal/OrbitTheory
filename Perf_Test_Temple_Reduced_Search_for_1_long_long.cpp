// Perf_Test_Temple_Reduced_Search_for_1_long_long.cpp
...
// 1, then n is a Prime number.
// 
// It avoids the cells already check with the Staircase search,
// and starts checking row by row as in the full Temple Search.
// The only difference between the full and reduces is that j starts at 3.
// If it finds a 1 as the value in any cell, then
