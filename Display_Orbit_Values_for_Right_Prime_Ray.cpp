// Display_Orbit_Values_for_Right_Prime_Ray.cpp
// Created by Alan Verdegraal -- July 30, 2022
//
// This program displays the Orbit values for the Right Prime Ray
// starting from the lowest value of k = n+1 and running up to 
// k = 2n-1. It uses the arithmetic progressions modulo k for the 
...
int main() {
   ...
   if (n % 2 == 0) {
	  ...
	  cout << "Only odd numbers can be checked." << endl; 
       ...
       cout << "List of Right Prime Ray Orbits for Number " << n << endl;
       ...
       cout << "If n is Prime, then the total of all Right Prime Ray ";
