// Validate_Sophie_Germain_Prime_Pairs.cpp
// Created by Alan Verdegraal July 14, 2023
//
// This checks the Sophie Germain Prime Orbit
// Structure at a variety of known Orbit Values 
// where On(d)=1. A Sophie Germain Prime Orbit
// Structure is based upon two primes where
// P2=2*P1+1.
//
...
int main() {
	...
	cout << "Validating Sophie Germain Prime Pairs: " << P1 << "  " << P2 << endl;
	cout << "==============================================" << endl;
    n=P1-2; d=(P1+1)/3 - 1;
	...
	n=P1; d=P1;
	orbit_value=get_orbit_value(n,d);
	cout << "T: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
	n=P2-1; d=P1;
	orbit_value=get_orbit_value(n,d);
	cout << "U: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
	n=P1+1; d=P1+1;
	orbit_value=get_orbit_value(n,d);
	cout << "V: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
	n=P2+1; d=P1+1;
	orbit_value=get_orbit_value(n,d);
	cout << "W: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
	n=P1+2; d=P1+2;
	orbit_value=get_orbit_value(n,d);
	cout << "X: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
	n=(P1+P2)/2; d=P1-1;
	orbit_value=get_orbit_value(n,d);
	cout << "Z: n=" << n << " d=" << d << " On(d)= " << orbit_value << endl;
