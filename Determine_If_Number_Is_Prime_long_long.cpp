// Determine_If_Number_Is_Prime_long_long.cpp
...
// is around the square root of the limit or about 3032000000. Actual testing has
...
int main() {
    ...
    value_if_prime = n * (n - 1)/2 + 1; // formula for the total of all Orbits if n is prime
