// Count_Half_Prime_Pairs_within_a_Range_3.cpp
...
// within a specified range. It does not displays the Prime Pairs
// as it proceeds. It prints out the even number and the count.
//
...
//		              cout << n << " { " << i << " , " << n-i << " }" << endl;
        ...
        cout << n << "  " << (total_pairs * 2) + found_1 << endl;
        total_pairs=0;
    }
}
