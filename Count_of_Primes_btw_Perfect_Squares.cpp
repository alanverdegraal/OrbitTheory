// Count_of_Primes_btw_Perfect_Squares.cpp
...
// It counts the number of primes between two Perfect Squares.
...
int main() {
    ...
    for (j = beginning_value; j <= ending_value; j++) {
		...
		cout << "Number of primes between " << first_square << " and " << next_square << " : " << count_of_primes << endl;
    }
}
